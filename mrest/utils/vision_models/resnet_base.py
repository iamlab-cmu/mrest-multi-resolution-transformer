...
def _resnet(
    ...
    **kwargs: Any,
    ...
    model = ResNetWithExtraModules(block, layers, **kwargs)
...
def resnet101(*, weights: Optional[ResNet101_Weights] = None, progress: bool = True, **kwargs: Any) -> ResNetWithExtraModules:
