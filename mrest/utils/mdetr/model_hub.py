...
from mrest.utils.mdetr.backbone import Backbone, Joiner, TimmBackbone
from mrest.utils.mdetr.mdetr_model import MDETR
from mrest.utils.mdetr.position_encoding import PositionEmbeddingSine
from mrest.utils.mdetr.postprocessors import PostProcess, PostProcessSegm
from mrest.utils.mdetr.segmentation import DETRsegm
from mrest.utils.mdetr.transformer import Transformer
...
def mdetr_resnet101_checkpoint():
    """
...
def mdetr_resnet101(pretrained=False, return_postprocessor=False):
    ...
    print(f"===> Will create default MDETR model, from checkpoint: {pretrained}")
